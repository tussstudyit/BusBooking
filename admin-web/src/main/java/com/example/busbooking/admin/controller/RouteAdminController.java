...
import com.example.busbooking.admin.service.RouteCatalogService;
...
public class RouteAdminController {
    ...
    public String list(Model model) {
        ...
        try {
            ...
            model.addAttribute("loadError", "Firestore load routes failed: " + rootMessage(e));
        }
    ...
    public String createForm(Model model) {
        ...
        model.addAttribute("pageTitle", "Create route");
