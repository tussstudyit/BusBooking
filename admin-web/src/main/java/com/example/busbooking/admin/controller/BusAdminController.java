...
public class BusAdminController {
    ...
    public String list(Model model) {
        ...
        try {
            ...
            model.addAttribute("loadError", "Firestore load buses failed: " + rootMessage(e));
        }
    ...
    public String createForm(Model model) {
        model.addAttribute("busForm", new BusForm());
        model.addAttribute("mode", "create");
        model.addAttribute("pageTitle", "Create bus");
        return "buses/form";
    }
    ...
    public String seats(@PathVariable String documentId, Model model) {
        try {
            ...
            model.addAttribute("loadError", "Không tải được dữ liệu ghế. Firestore đang hết quota hoặc tạm thời không phản hồi.");
        }
